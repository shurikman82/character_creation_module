"""Модуль запрашивает имя персонажа, тип. Возвращает типовые характеристики."""
from random import randint


def attack(char_name: str, char_class: str) -> str:
    """В зависимости от типа персонажа определяет урон от атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от типа персонажа определяет уровень блока урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от типа персонажа определяет спецприем."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """В зависимости от типа персонажа определяет тренировку."""
    if char_class == 'warrior':
        print(f'{char_name}, '
...
def main():
    """Выбирает имя персонажа и его тип."""
